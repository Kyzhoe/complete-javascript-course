...
const jonasNew = `I'm ${firstName} and I am a ${year - birthYear} year old ${job}!`;
...
if (favorite === 69) { // 68 === 69 -> FALSE
    console.log(`Cool! 69 is an amazing number`);
} else if (favorite === 420) {
    console.log(`420 is also a cool number`);
} else if (favorite === 69420) {
    console.log(`69420 is also a cool number`);
} else {
    console.log(`Number is not 69 or 420`);
}
